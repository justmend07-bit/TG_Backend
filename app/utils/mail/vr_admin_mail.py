...
"""
    ...
    approve = f"http://localhost:8000/admin/vr-darshan/action?booking_id={booking.id}&action=approve"
    decline_age = f"http://localhost:8000/admin/vr-darshan/action?booking_id={booking.id}&action=decline_age"
    decline_payment = f"http://localhost:8000/admin/vr-darshan/action?booking_id={booking.id}&action=decline_payment"
